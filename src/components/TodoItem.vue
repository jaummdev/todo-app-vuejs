...
mr-2">
                <button @click="isCheckCompleted()" :class="{
                    'text-green-500 bg-green-500/10 rounded-full cursor-pointer': isCompleted,
                    'text-gray-400 bg-transparent cursor-pointer': !isCompleted
                }">
            ...
            <div class="w-full">
                <input v-model="title" @keyup.enter="updateTodo" type="text" placeholder="Digite a sua tarefa"
...
justify-center">
                <button @click="onDelete()" class="focus:outline-none text-red-500 cursor-pointer">
                    <svg class="ml-3 h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                        xmlns="http://www.w3.org/2000/svg">
